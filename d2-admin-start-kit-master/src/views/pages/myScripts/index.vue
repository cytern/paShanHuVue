  ...
  <d2-container>
    ...
    <el-table-column
      ...
      <template slot-scope="scope">
        ...
        <span style="margin-left: 10px">{{ scope.row.jsoupMissionAll.maName }}</span>
      </template>
    </el-table-column>
    <el-table-column
      label="脚本详细"
      ...
      <template slot-scope="scope">
        <el-popover trigger="hover" placement="top">
          ...
          <div slot="reference" class="name-wrapper">
            <el-tag size="medium">{{ scope.row.jsoupMissionAll.maTip}}</el-tag>
          </div>
        </el-popover>
      </template>
    </el-table-column>
     <el-table-column
      ...
      <template slot-scope="scope">
        ...
        <span style="margin-left: 10px">{{ scope.row.jsoupMissionAll.malStartUrl }}</span>
      </template>
    </el-table-column>
      <el-table-column
      label="结果集名称"
      ...
      <template slot-scope="scope">
        ...
        <span style="margin-left: 10px">{{ scope.row.jsoupMissionAll.maSuccessFileName }}</span>
      </template>
    </el-table-column>
